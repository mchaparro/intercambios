...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ParticipantesEvento.intercambio'
        db.alter_column(u'intercambios_participantesevento', 'intercambio', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'ParticipantesEvento.intercambio'
        db.alter_column(u'intercambios_participantesevento', 'intercambio', self.gf('django.db.models.fields.IntegerField')(null=True))
