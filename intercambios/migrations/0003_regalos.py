...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.Regalo.objects.create(opcion_regalo="Libros")
        orm.Regalo.objects.create(opcion_regalo="Chocolates")
        orm.Regalo.objects.create(opcion_regalo="Bebidas Alcoholicas")
        orm.Regalo.objects.create(opcion_regalo="Bolsas/Accesorios")
        orm.Regalo.objects.create(opcion_regalo="Ropa")
        orm.Regalo.objects.create(opcion_regalo="Perfumes")
        orm.Regalo.objects.create(opcion_regalo="Electronica")
        orm.Regalo.objects.create(opcion_regalo="CD/DVD")
        orm.Regalo.objects.create(opcion_regalo="Otro")
    ...
    models = {
        ...
        'intercambios.regalo': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'opcion_regalo': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'})
        },
