...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Regalo', fields ['opcion_regalo']
        db.create_unique(u'intercambios_regalo', ['opcion_regalo'])


    def backwards(self, orm):
        # Removing unique constraint on 'Regalo', fields ['opcion_regalo']
        db.delete_unique(u'intercambios_regalo', ['opcion_regalo'])
