...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Evento.fecha_evento'
        db.alter_column(u'intercambios_evento', 'fecha_evento', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Evento.fecha_evento'
        db.alter_column(u'intercambios_evento', 'fecha_evento', self.gf('django.db.models.fields.DateTimeField')())
