...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParticipantesEvento.intercambio'
        db.add_column(u'intercambios_participantesevento', 'intercambio',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Usuario.intercambio'
        db.delete_column(u'intercambios_usuario', 'intercambio_id')


    def backwards(self, orm):
        # Deleting field 'ParticipantesEvento.intercambio'
        db.delete_column(u'intercambios_participantesevento', 'intercambio')

        # Adding field 'Usuario.intercambio'
        db.add_column(u'intercambios_usuario', 'intercambio',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='regala_a', null=True, to=orm['intercambios.Usuario'], blank=True),
                      keep_default=False)
