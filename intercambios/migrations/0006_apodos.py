...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Usuario.nickname'
        db.delete_column(u'intercambios_usuario', 'nickname')

        # Adding field 'Usuario.apodo'
        db.add_column(u'intercambios_usuario', 'apodo',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Usuario.nickname'
        db.add_column(u'intercambios_usuario', 'nickname',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Usuario.apodo'
        db.delete_column(u'intercambios_usuario', 'apodo')
    ...
    models = {
        ...
        'intercambios.usuario': {
            ...
            'apodo': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
